 ...
 * ViraWiFiManager, a library for the ESP8266/Arduino platform
 * for configuration of WiFi credentials using a Captive Portal
 *
 * @author ViraMedar(Mostafa Mir Mousavi)
 * @author Mostafa Mir Mousavi
 * @version 1.0.21
 * @license t.me/ViraMedar
 */

#ifndef _vwm_STRINGS_EN_H_
#define _vwm_STRINGS_EN_H_
...
#include "vwm_consts_en.h" // include constants, tokens, routes

const char vwm_LANGUAGE[] PROGMEM = "en-US"; // i18n lang code
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'>   <br/>   <label for='p'>Password</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'>    <br/>       <input type='checkbox' id='showpass' onclick='f()'> <label for='showpass'>Show Password</label>      </br> <hr>  <input type='checkbox' id='static' name='static'> <label for='static'>Static</label>  <br/>   <label for='s'>Server IP</label><input id='si' name='si' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''>   <br/>  <label for='n'>Subnet</label><input id='sb' name='sb' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''>   <br/>   <label for='g'>Getway</label><input id='sg' name='sg' maxlength='32' autocorrect='off' autocapitalize='none' placeholder=''>   <br/>";
...
const char HTTP_HELP[]             PROGMEM =
 "<center><br/><h3>Copyright</h3><hr>"
 "<table class='table'>"
 //"<thead><tr><th>Designer and programmer</th></tr></thead><tbody>"
 "<tr><td>Designer and programmer : <a href='http://t.me/viramedar'>Mostafa Mir Mousavi</a></td></tr>"
 ...
 "</table>"
 //"<center>"
 "<p/>All rights reserved © <br><a href='https://youtube.com/@viramedar'>ViraMedar(Vira Etemad Parsan Co.)</a>"
 "</center>";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
#else
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Device Info - ESP8266</h3><hr><dl>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>OS Version</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>IDE</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutsdk[]     PROGMEM = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    PROGMEM = "<dt>Build date</dt><dd>{1}</dd>";

const char S_brand[]              PROGMEM = "Vira Network Manager";
const char S_debugPrefix[]        PROGMEM = "*ViraWM*";
...
const char S_titlewifi[]          PROGMEM = "Config VE";
...
#ifdef ESP8266
    const char S_ssidpre[]        PROGMEM = "ESP8266";
#elif defined(ESP32)
    const char S_ssidpre[]        PROGMEM = "ESP32";
#else
    const char S_ssidpre[]        PROGMEM = "VWM";
#endif
