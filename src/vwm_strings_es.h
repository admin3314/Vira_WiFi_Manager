...
/**
 * ADD TO BUILD FLAGS
 * -Dvwm_STRINGS_FILE="\"vwm_strings_es.h\""
 */
...
const char vwm_LANGUAGE[] PROGMEM = "es-ES"; // i18n lang code
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "</table>"
 "<p/>Powered By <a href='https://t.me/viramedar'>https://t.me/viramedar</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>ViraWiFiManager</dt><dd>{1}</dd>";
...
const char S_brand[]              PROGMEM = "ViraWiFiManager";
